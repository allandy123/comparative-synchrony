...
1. Title of Dataset: Synchrony matrices for defoliation amongst 25km2 grid cells.
...
For each species and country, these files contain the synchrony matrices (correlation through time among rows) for the files contained in the files in ./data/defoliation/25km_GT2Years_diff. Rows and columns here do not have names, but they both correspond to the rows in order contained within the corresponding defoliation files.
...
DATA-SPECIFIC INFORMATION FOR csv files in ./data/defolation/synchrony_matrices/
