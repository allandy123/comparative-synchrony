...
1. File List:
File naming convention: ca_<species code>.csv, where species codes can be found below. Files beginning with "usa_" only. Canada files are similar, but have a different spatial projection.
...
DATA-SPECIFIC INFORMATION FOR csv files in ./data/weather/PCA/
