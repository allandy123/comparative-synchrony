...
1. Title of Dataset: Results of PCA analysis.
...
5. Was data derived from another source? Yes
	A. If yes, list source(s): PCA run on weather data derived from ANUSPLIN, as defined in the Readme, scripts, and metadata 		within this repository.
